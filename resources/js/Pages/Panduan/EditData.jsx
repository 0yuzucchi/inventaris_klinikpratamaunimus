...
// // Komponen Step yang sama untuk konsistensi visual
...
//                              <div className="mt-2 p-3 bg-blue-50 dark:bg-slate-700/50 rounded-md text-sm text-blue-700 dark:text-blue-300">
...
//                     <li><b>Gunakan "Batal":</b> Untuk kembali ke halaman daftar tanpa menyimpan perubahan apa pun.</li>
//                 </ol>
//             </section>

//             <div className="mt-10 bg-blue-50 dark:bg-slate-700/50 p-4 rounded-lg">
//                 <div className="flex items-start gap-3">
//                     <LightBulbIcon className="h-6 w-6 text-blue-500 dark:text-blue-400 flex-shrink-0" />
//                     <div>
//                         <h3 className="font-bold text-blue-800 dark:text-blue-300">Tips & Trik</h3>
...
//     return (
//         <PanduanLayout title="Panduan: Edit Data">
//             <EditDataContent />
//         </PanduanLayout>
//     );
// }
...
// import React from 'react';
// import { LightBulbIcon, ExclamationTriangleIcon, ChevronDoubleDownIcon } from '@heroicons/react/24/solid';
// import PanduanLayout from './PanduanLayout';

// // Menggunakan komponen Step yang sama, namun dengan warna berbeda (biru) untuk membedakan
// const Step = ({ number, title, children }) => (
//     <div className="flex items-start gap-4">
//         <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-sky-600 text-white font-bold">
//             {number}
//         </div>
//         <div>
//             <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">{title}</h3>
...
//             </h1>
//             <p className="mt-2 text-slate-600 dark:text-slate-400">
//                 Panduan ini menjelaskan cara mengubah banyak data inventaris sekaligus secara efisien menggunakan fitur "Seragamkan Data" dan editor per item.
//             </p>
//             <hr className="my-6 border-slate-200 dark:border-slate-700" />

//             {/* Bagian 1: Cara Cepat - Seragamkan Data */}
//             <section>
//                 <h2 className="text-2xl font-semibold text-slate-800 dark:text-white">
//                     Bagian 1: Cara Cepat - Seragamkan Data (Opsional)
//                 </h2>
//                 <p className="mt-1 text-sm text-slate-500 dark:text-slate-400 mb-6">
//                     Gunakan bagian ini untuk menerapkan perubahan yang sama ke SEMUA item di bawah. Sangat efisien untuk update serentak.
//                 </p>
//                 <div className="divide-y divide-slate-200 dark:divide-slate-700">
//                     <div className="pb-6">
//                         <Step number="1" title="Isi Kolom yang Ingin Diubah">
//                             <p>Di area <strong>"Seragamkan Data"</strong>, isi satu atau beberapa kolom yang nilainya ingin Anda samakan untuk semua item.</p>
//                             <p className="mt-2"><b>Contoh:</b> Untuk memindahkan semua item ke satu lokasi, cukup isi kolom <code className="font-mono bg-slate-200 dark:bg-slate-700 px-1 rounded">Tempat Pemakaian</code> dan <code className="font-mono bg-slate-200 dark:bg-slate-700 px-1 rounded">Nomor Ruang</code>.</p>
//                         </Step>
//                     </div>
//                     <div className="pt-6">
//                         <Step number="2" title="Terapkan Perubahan ke Semua Item">
//                             <p>Klik tombol <code className="font-mono bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 px-2 py-1 rounded inline-flex items-center gap-1"><ChevronDoubleDownIcon className="w-4 h-4"/> Terapkan Semua Perubahan</code>.</p>
//                              <div className="mt-2 p-3 bg-green-50 dark:bg-slate-700/50 rounded-md text-sm text-green-700 dark:text-green-300">
//                                 <ul className="list-disc list-inside space-y-1">
//                                     <li>Data yang Anda isi akan otomatis disalin ke setiap item di daftar bawah.</li>
//                                     <li>Sebuah notifikasi akan muncul menandakan perubahan berhasil diterapkan.</li>
//                                     <li>Anda masih bisa mengubah data per item setelah langkah ini.</li>
//                                 </ul>
//                             </div>
//                         </Step>
//                     </div>
...
//             {/* Bagian 2: Penyesuaian Detail per Item */}
//             <section>
//                 <h2 className="text-2xl font-semibold text-slate-800 dark:text-white">
//                     Bagian 2: Penyesuaian Detail per Item
//                 </h2>
//                 <p className="mt-1 text-sm text-slate-500 dark:text-slate-400 mb-6">
//                     Setelah atau tanpa menggunakan fitur "Seragamkan Data", Anda bisa mengubah setiap item secara individual.
//                 </p>
//                 <div className="divide-y divide-slate-200 dark:divide-slate-700">
//                     <div className="pb-6">
//                         <Step number="1" title="Buka Detail Item">
//                             <p>Klik pada baris item yang ingin diubah. Form detail untuk item tersebut akan terbuka di bawahnya.</p>
//                         </Step>
//                     </div>
//                     <div className="py-6">
//                         <Step number="2" title="Edit Sesuai Kebutuhan">
//                             <p>Ubah data pada kolom-kolom yang tersedia. Perubahan di sini hanya berlaku untuk item yang sedang Anda buka.</p>
//                         </Step>
//                     </div>
//                     <div className="pt-6">
//                         <Step number="3" title="Perhatikan Peringatan Error">
//                              <p>Jika Anda melihat ikon peringatan <ExclamationTriangleIcon className="w-5 h-5 inline-block text-red-600"/> di sebelah nama item, itu artinya ada konflik data.</p>
//                              <div className="mt-2 flex items-start gap-2 text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 p-3 rounded-md">
//                                 <ExclamationTriangleIcon className="h-5 w-5 mt-0.5 flex-shrink-0" />
//                                 <div>
//                                     <h4 className="font-bold">Error Validasi</h4>
//                                     <p className="text-sm">Ini biasanya terjadi jika ada konflik <code className="font-mono text-xs">Tempat Pemakaian</code> & <code className="font-mono text-xs">Nomor Ruang</code>. Buka item tersebut dan perbaiki kolom yang ditandai merah sebelum menyimpan.</p>
//                                 </div>
//                             </div>
//                         </Step>
//                     </div>
...
//             {/* Bagian 3: Menyimpan Semua Perubahan */}
//             <section>
//                 <h2 className="text-2xl font-semibold text-slate-800 dark:text-white">Bagian 3: Menyimpan Semua Perubahan</h2>
//                 <ol className="list-decimal list-inside mt-4 space-y-2 text-slate-600 dark:text-slate-400">
//                     <li><b>Periksa Kembali:</b> Pastikan tidak ada lagi ikon peringatan <ExclamationTriangleIcon className="w-4 h-4 inline-block text-red-600"/> pada daftar item.</li>
//                     <li><b>Klik "Simpan Semua Perubahan":</b> Tombol di bagian bawah akan menyimpan semua modifikasi yang telah Anda buat, baik dari fitur seragamkan maupun dari editor per item.</li>
//                     <li><b>Gunakan "Batalkan":</b> Untuk membatalkan semua perubahan dan kembali ke halaman daftar.</li>
//                 </ol>
//             </section>

//             <div className="mt-10 bg-sky-50 dark:bg-slate-700/50 p-4 rounded-lg">
//                 <div className="flex items-start gap-3">
//                     <LightBulbIcon className="h-6 w-6 text-sky-500 dark:text-sky-400 flex-shrink-0" />
//                     <div>
//                         <h3 className="font-bold text-sky-800 dark:text-sky-300">Tips & Trik</h3>
//                         <ul className="list-disc list-inside mt-2 text-sm text-sky-700 dark:text-sky-300 space-y-1">
//                             <li>Untuk efisiensi maksimal, gunakan fitur <strong>Seragamkan Data</strong> terlebih dahulu, baru lakukan penyesuaian kecil pada masing-masing item jika perlu.</li>
//                             <li>Jika hanya ingin mengubah 1 atau 2 field (misal: Asal Perolehan), fitur "Seragamkan Data" adalah cara tercepat.</li>
//                             <li>Sistem tidak akan bisa menyimpan jika masih ada item dengan error validasi. Pastikan semua peringatan telah diatasi.</li>
//                         </ul>
//                     </div>
//                 </div>
//             </div>
...
// export default function BulkEditPanduan() {
//     return (
//         <PanduanLayout title="Panduan: Edit Massal">
//             <BulkEditPanduanContent />
//         </PanduanLayout>
//     );
// }
...
// --- KOMPONEN STEP UNTUK MASING-MASING PANDUAN ---
